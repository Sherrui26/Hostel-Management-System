...
if(isset($_POST['submit'])) {
   ...
   /* oci_bind_by_name($stmt, ":id", $id);
    ...
    oci_bind_by_name($stmt, ":egycontactno", $egycontactno);
    oci_bind_by_name($stmt, ":guardianName", $guardianName);
    oci_bind_by_name($stmt, ":guardianRelation", $guardianRelation);
    oci_bind_by_name($stmt, ":guardianContactno", $guardianContactno);
    oci_bind_by_name($stmt, ":corresAddress", $corresAddress);
    oci_bind_by_name($stmt, ":corresCity", $corresCity);
    oci_bind_by_name($stmt, ":corresState", $corresState);
    oci_bind_by_name($stmt, ":corresPincode", $corresPincode);
    oci_bind_by_name($stmt, ":pmntAddress", $pmntAddress);
    oci_bind_by_name($stmt, ":pmntCity", $pmntCity);
    oci_bind_by_name($stmt, ":pmntState", $pmntState);
    oci_bind_by_name($stmt, ":pmntPincode", $pmntPincode);*/
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <form method="post" action="" class="form-horizontal">
                                            ...
                                            //oci_bind_by_name($stmt1, ":aid1", $aid1);
                                            oci_execute($stmt1);
