...
if(isset($_POST['submit']))
{
    ...
    oci_bind_by_name($stmt, ':email', $emailid);
    ...
    {
        $query="insert into userRegistration(regNo,firstName,middleName,lastName,gender,contactNo,email,password) values(:regno,:fname,:mname,:lname,:gender,:contact,:email,:password)";
