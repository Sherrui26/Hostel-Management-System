...
if(isset($_POST['submit']))
{
    ...
    $query = "UPDATE courses SET course_code = :coursecode, course_sn = :coursesn, course_fn = :coursefn WHERE id = :id";
    $stm = oci_parse($dbconn, $query);
    oci_bind_by_name($stm, ":coursecode", $coursecode);
    oci_bind_by_name($stm, ":coursesn", $coursesn);
    oci_bind_by_name($stm, ":coursefn", $coursefn);
