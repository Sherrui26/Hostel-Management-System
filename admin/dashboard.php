									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-danger text-light">
												<div class="stat-panel text-center">
<?php
$query = "SELECT count(*) AS count FROM complaints WHERE complaintStatus IS NULL";
$stm = oci_parse($dbconn, $query);
oci_execute($stm);
$row = oci_fetch_assoc($stm);
$count = $row['COUNT'];
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php
$query = "SELECT count(*) AS count FROM complaints WHERE complaintStatus='In Process'";
$stm = oci_parse($dbconn, $query);
oci_execute($stm);
$row = oci_fetch_assoc($stm);
$count = $row['COUNT'];
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
<?php
$query = "SELECT count(*) AS count FROM complaints WHERE complaintStatus='Closed'";
$stm = oci_parse($dbconn, $query);
oci_execute($stm);
$row = oci_fetch_assoc($stm);
$count = $row['COUNT'];
