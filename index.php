...
if(isset($_POST['login']))
{
	...
	$email2 = $_POST['emailreg'];
    $password2 = $_POST['password'];
	$aid99 = $_POST['emailreg'];

	$query99 = "SELECT EMAIL FROM userregistration WHERE regNo = :email AND password = :password";
    ...
    $query = "SELECT email, password, id FROM userregistration WHERE regNo = :emailreg AND password = :password";
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									...
									<input type="text" placeholder="Registration Number" name="emailreg" class="form-control mb" required="true">
